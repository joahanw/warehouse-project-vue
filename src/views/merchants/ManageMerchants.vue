          ...
          <div class="flex flex-col gap-[6px]">
            <p class="flex items-center gap-[6px]">
              ...
              <span class="font-semibold text-2xl"
                >{{ merchants.length }} Total Merchants</span
              >
            </p>
...
export default {
  ...
  methods: {
    ...
    nextPage() {
      if (this.currentPage < this.pagination.totalPages) this.currentPage++;
      this.fetchMerchants();
    },
    previousPage() {
