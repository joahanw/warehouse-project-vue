<template>
  <Layout
    pageTitle="Edit Merchants"
    breadcrumb-text="Edit Merchants"
          ...
          <div class="flex items-center justify-between w-full">
            ...
            >
              <img
                ...
                data-original="@/assets/images/thumbnails/merchant-1.png"
          ...
          <ul class="flex flex-col gap-4">
            <li class="flex gap-[6px]">
              ...
              <p class="font-medium leading-[140%]">
                Ensure merchant information is updated accurately to maintain
                data consistency
              </p>
            </li>
            <li class="flex gap-[6px]">
              ...
              />
              <p class="font-medium leading-[140%]">
                Make sure the phone number is active to ensure seamless
                communication
              </p>
            </li>
            <li class="flex gap-[6px]">
              ...
              />
              <p class="font-medium leading-[140%]">
                Verify the assigned keeper if there has been a change Lorem
                Ipsum
              </p>
            </li>
            <li class="flex gap-[6px]">
              ...
              />
              <p class="font-medium leading-[140%]">
                Verify the warehouse address to ensure accurate inventory
                management
              </p>
            </li>
            <li class="flex gap-[6px]">
...
export default {
  ...
  computed: {
    selectedKeeper() {
      if (!this.form.keeperId) return null;
      return this.keepers.user.find(
        (keeper) => keeper.user.id == this.form.keeperId,
      );
    },
  },
  methods: {
    ...
    async handleSubmit() {
      ...
      if (isNaN(this.form.keeperId) || this.form.keeperId <= 0) {
      ...
      try {
        ...
        const requestData = {
          ...
          keeperId: parseInt(this.form.keeperId),
