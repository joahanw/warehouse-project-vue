<template>
  <Layout
    ...
    breadcrumb-text="Edit Warehouse"
      ...
      <div class="flex gap-6">
        ...
        >
          ...
          <div class="flex items-center justify-end gap-4">
            <a href="/warehouses" class="btn btn-red font-semibold"> Cancel </a>
        ...
        >
          ...
          <ul class="flex flex-col gap-4">
            ...
            <li class="flex gap-[6px]">
              ...
              />
              <p class="font-medium leading-[140%]">
                Ensure the Warehouse Address is Correct and Complete Color det
                amet
              </p>
            </li>
            <li class="flex gap-[6px]">
            ...
            <li class="flex gap-[6px]">
              ...
              />
              <p class="font-medium leading-[140%]">
                Double-Check Everything Lorem Ipsum
              </p>
            </li>
          </ul>
        </div>
