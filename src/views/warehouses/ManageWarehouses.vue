          ...
          <div class="flex flex-col gap-[6px]">
            <p class="flex items-center gap-[6px]">
              ...
              <span class="font-semibold text-2xl"
                >{{ totalRecords }} Total Warehouses</span
              >
            </p>
        ...
        <div id="Product-List" class="flex flex-col px-4 gap-5 flex-1">
          ...
          <div v-else class="flex flex-col gap-5">
            <template v-for="warehouse in warehouses" :key="warehouse.id">
              ...
              >
                <div class="flex items-center gap-3 w-full xl:w-[360px] xl:shrink-0">
                  <div
                ...
                <div class="flex items-center gap-2 xl:flex-1 xl:justify-center">
                  <img
                  ...
                  <p class="font-semibold text-base xl:text-lg text-nowrap">
                    {{ warehouse.countProduct }} Products
                  </p>
                </div>
  ...
  methods: {
    async fetchWarehouses() {
      try {
        ...
        this.warehouses = response.data?.content || response || [];
