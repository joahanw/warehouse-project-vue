          ...
          >
            ...
            >
              ...
              <div class="flex items-center justify-between">
                ...
                <span class="font-semibold">{{ form.stock }}</span>
              </div>
              <hr class="border-monday-border" />
              <div class="flex items-center justify-between">
                <span class="font-semibold text-lg">Difference:</span>
                <span
                  :class="getStockDifferenceClass()"
...
export default {
  ...
  methods: {
    async loadWarehouseProduct() {
      try {
        const warehouseId =
          this.$route.query.warehouse || this.$route.params.warehouseId;
        const productId =
          this.$route.query.productId || this.$route.params.productId;
        ...
        const response = await getWarehouseProductByWarehouseIDAndProductID(
          warehouseId,
          productId,
        );
    ...
    getStockDifference() {
      if (this.form.stock === "") return 0;
      const difference = this.form.stock - this.currentStock;
