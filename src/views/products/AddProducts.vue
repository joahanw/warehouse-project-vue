<template>
  <Layout
    ...
    breadcrumb-text="Add New Product"
      ...
      <div class="flex gap-6">
        ...
        >
          ...
          <div class="flex items-center justify-between w-full">
            ...
            <div
              v-if="imageUploading"
              class="w-[152px] bg-gray-200 rounded-full h-2"
            >
              <div
            ...
            <button
              ...
              type="button"
              @click="removeImage"
              class="btn btn-black w-[152px] font-semibold text-nowrap text-sm"
            >
              Remove Photo
            </button>
            <input
          ...
          <ul class="flex flex-col gap-4">
            <li class="flex gap-[6px]">
              ...
              <p class="font-medium leading-[140%]">
                Use Clear and High-Quality Photos for Better Results lorem ipsum
                mix
              </p>
            </li>
            <li class="flex gap-[6px]">
              ...
              />
              <p class="font-medium leading-[140%]">
                Ensure the Product Name is Relevant and Descriptive less lorem
                ipsum
              </p>
            </li>
            <li class="flex gap-[6px]">
            ...
            <li class="flex gap-[6px]">
              ...
              />
              <p class="font-medium leading-[140%]">
                Review Everything Carefully Before Publishing lorem ipsum color
                amet
              </p>
            </li>
          </ul>
  ...
  setup() {
    ...
    const validateForm = () => {
      ...
      if (
        ...
        !/^[0-9A-Za-z\-]+$/.test(form.value.barcode.trim())
      ) {
        throw new Error(
          "Barcode hanya boleh berisi angka, huruf, dan tanda hubung",
        );
      }
      return true;
    };
    ...
    const handleSubmit = async () => {
      ...
      try {
        ...
        const productData = {
          ...
          categoryId: parseInt(form.value.category),
