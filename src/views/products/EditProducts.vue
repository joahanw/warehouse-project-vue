          ...
          <ul class="flex flex-col gap-4">
            <li class="flex gap-[6px]">
              ...
              <p class="font-medium leading-[140%]">
                Update Product Photos if Necessary
              </p>
            </li>
            <li class="flex gap-[6px]">
              <img
      ...
      try {
        ...
        if (product) {
          ...
          Object.assign(form.value, {
            ...
            popularity:
              product.isPopular !== undefined ? product.isPopular : false,
            about: product.about || "",
            image: product.thumbnail || defaultImage,
            barcode: product.barcode || "",
          });
          originalImage.value = product.thumbnail || defaultImage;
