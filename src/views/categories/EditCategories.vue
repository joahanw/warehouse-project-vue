<template>
  <Layout
    ...
    breadcrumb-text="Edit Categories"
      ...
      <div v-else class="flex gap-6">
        ...
        >
          ...
          <div class="flex items-center justify-end gap-4">
            <a href="/categories" class="btn btn-red font-semibold"> Cancel </a>
        ...
        >
          ...
          <ul class="flex flex-col gap-4">
            ...
            <li class="flex gap-[6px]">
              ...
              />
              <p class="font-medium leading-[140%]">
                Ensure the Name is Still Relevant and Accurate Lorem Ipsum
                Simply text
              </p>
            </li>
            <li class="flex gap-[6px]">
              ...
              />
              <p class="font-medium leading-[140%]">
                Verify the Image is Appropriate and Relevant Lorem Ipsum Color
                Text Mix
              </p>
            </li>
            <li class="flex gap-[6px]">
              ...
              />
              <p class="font-medium leading-[140%]">
                Adjust the Parent Category if Needed for Accuracy Lorem Ipsum is
                Text Simply
              </p>
            </li>
            <li class="flex gap-[6px]">
...
export default {
  ...
  methods: {
    async loadCategory() {
      ...
      try {
        ...
        this.category = {
          ...
          countProduct: categoryData.countProduct || 0,
        };

        this.form = {
          name: this.category.name || "",
          tagline: this.category.tagline || "",
    ...
    async handleSubmit() {
      if (!this.form.name || !this.form.tagline) {
