<template>
  <label
    class="flex py-4 px-6 rounded-3xl border-[1.5px] border-monday-border focus-within:border-monday-black transition-300"
  >
    ...
    <div class="flex flex-col gap-[6px] pl-4 w-full">
      ...
      <div
        ...
        class="text-sx text-gray-500 text-right"
      >
